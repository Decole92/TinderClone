...
const MatchScreen = () => {
  ...
  return (
   ...
   <Text style={tw("text-white text-center mt-5")}>
    You and {userSwiped.displayName} have liked each Other.</Text>

      <View style={[tw("flex-row justify-evenly items-center mt-5"), styles.mat]}>
        ...
        <AntDesign style={tw("justify-center transparent center-50 items-center")} name={status} size={80} color="grey"/>
...
style={tw("bg-white m-5 px-10 py-8 rounded-full mt-20")}>
   <Text style={tw("text-center justify-center font-bold")}>Send a Message</Text>
  </TouchableOpacity>
