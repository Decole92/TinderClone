  ...
  return (
    <KeyboardAwareScrollView>
      <View style={tw("flex-1 items-center pt-5")}>
        ...
        <Text style={tw("text-xl text-gray-500 p-3  font-bold")}>
        ...
        <TouchableOpacity
          onPress={onShowPopup}
          style={[
            tw("h-40 w-40 items-center justify-center rounded-full"),
            styles.camero,
          ]}
        >
          {!selectedImage ? (
            <Fontisto name="camera" size={50} color="white" />
          ) : (
            <Image
              source={{ uri: selectedImage }}
              style={tw("h-40 w-40 rounded-full items-center-justify-center")}
            />
          )}
          ...
          <View>
            {!selectedImage ? (
              <MaterialIcons
                style={tw("absolute left-9 top-55")}
                name="add-circle"
                size={40}
                color="white"
              />
        ...
        <Text
          style={[
            tw("text-center p-3 font-bold text-xl text-red-400"),
            styles.gap,
          ]}
        >
          Step 1: My job is
        ...
        <BottomPopup
          ...
          body={
            <MaterialCommunityIcons
              ...
              name="folder-image"
              size={30}
              style={{ color: "#FF5864", flex: 1, justifyContent: "flex-end" }}
            />
          }
